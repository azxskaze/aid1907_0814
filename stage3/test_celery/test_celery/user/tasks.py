...
def task_test():
    config = {
       		"accountSid": "8aaf07086e0115bb016e40967d37232d",  # 主账户id
      		"appToken": "a80d52c4fab7405e9275ff4d96894fa9",  # 令牌
        	"appId": "8aaf07086e0115bb016e40967d942333",  # 应用id
        	"templateId": "1"  # 模版id
   		 }
    phone = '15691649205'  # 手机号，如果是多个手机号用英文的,分割 比如#13200000000,13300000000
    code = '0000'  # 验证码
